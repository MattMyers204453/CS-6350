...
df = read_data_into_dataframe("train_final.csv", attributes, continuous_attributes, False, 100)
#sys.displayhook(df)
test_df = read_data_into_dataframe("test_final.csv", attributes[:-1], continuous_attributes, True, 100)
